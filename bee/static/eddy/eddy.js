...
var $eddy_dico = [
  ...
  { text: 'hide-sql: true', displayText: 'a_hide-sql' },
  ...
  { text: 'format-sql: "select strftime(\'%H:%M:%S\', {Milliseconds}/1000, \'unixepoch\')"', displayText: 'e_format-sql' },
  ...
  { text: 'form: ""', displayText: 'p_form (section)' },
  { text: 'header: ""', displayText: 'p_header' },
  { text: 'icon-name: ""', displayText: 'p_icon-name (section)' },
  { text: 'join: ""', displayText: 'p_join (jointure)' },
