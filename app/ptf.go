...
var ptfViews = types.Views{
	"vactiv": {
		...
		Elements: types.Elements{
			"ptf_id":    {Order: 10, HideOnMobile: true},
			"ptf_name":  {Order: 20},
			"ptf_note":  {Order: 30, HideOnMobile: true},
			"ptf_top":   {Order: 40, HideOnMobile: true},
			"ptf_rem":   {Order: 50, HideOnMobile: true},
			"ptf_quote": {Order: 60, HideOnMobile: true},
			"ptf_gain":  {Order: 70},
		},
		Where:   "ptf_enabled = '1'",
		OrderBy: "ptf_name",
	...
	"vall": {
		...
		Elements: types.Elements{
			...
			"ptf_note":    {Order: 40, HideOnMobile: true},
			"ptf_top":     {Order: 50, HideOnMobile: true},
			"ptf_rem":     {Order: 60, HideOnMobile: true},
			"ptf_quote":   {Order: 70, HideOnMobile: true},
			"ptf_gain":    {Order: 80},
		},
		OrderBy: "ptf_name",
	},
